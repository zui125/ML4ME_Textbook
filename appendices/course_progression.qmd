...
- Review several basics that should have been covered in the prior Stochastics and Machine Learning course
    - @sec-cross-validation for a review of Cross Validation in [Evaluating ML Models](../part1/evaluating_models.qmd)
    - @sec-diagonstic-plots for Plotting/Diagnostics of ML models in [Evaluating ML Models](../part1/evaluating_models.qmd)
    - [Review of Linear models](../part2/review_linear_models.qmd)
- Example of how to use a Jupyter Notebook in class -- [Review of Linear Regression](../part2/review_linear_models.qmd) and [Stochastic Gradient Descent](../part1/gradient_descent.qmd)
...
### Lecture 3: Review of (Stochastic) Gradient Descent
...
### Lecture 8: Push-Forward Generative Models
...
### Lecture 10: Stochastic Generative Models
...
### Lecture 11: Latent Generative Neural Models
